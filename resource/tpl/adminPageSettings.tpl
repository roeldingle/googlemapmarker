...
<form name="<?php echo $APP_NAME;?>_form" id="googlemapmark_form" action="setup.php" method="POST">
	...
	<tr>
		...
		<td><input type="text" style="width:300px" id="<?php echo $APP_NAME;?>_caption"  name="<?php echo $APP_NAME;?>_caption" /></td>
	</tr>
			...
			<span class="location"  >
				...
				<?php  $counter = 0; foreach($aMarkers as $val){ ?>
					<div class="add_location" id="<?php echo $APP_NAME;?>_marker_con_<?php echo $counter;?>" >
						<input type="text"  value="<?php echo $val['loc'];?> (<?php echo $val['lat'];?>,<?php echo $val['lng'];?>)" readonly name="<?php echo $APP_NAME;?>_marker[]"  class="textbox" value="" style="width:300px" />
				...
				<p>
					...
					<input type="button" class="btn" value="Add New Marker" onclick="adminPageSettings.open_popup('googlemapmarker_set_center',400,'Add Marker');" style="width:302px;height:20px;cursor:pointer" />
				</p>
...
<div>
	...
	<table border="0" cellspacing="0" class="tbl_option">
		<tbody><tr>
			...
			<input id="zoom_control" name="zoom_control" type="checkbox" onclick="adminPageSettings.optZoom()">
			...
			<td style="width:179px;">
				...
				<select title="select rows" class="rows" name="zoom_size" id="zoom_size" disabled="" onchange="adminPageSettings.changeZoomCtrSize();">
			...
			<td>
				...
				<select title="select rows" class="rows" name="zoom_position" id="zoom_position" disabled="" onchange="adminPageSettings.changeZoomCtrPos();">
		...
		<tr>
			<td>
			<input type="checkbox" name="map_type_control" id="map_type_control" onclick="adminPageSettings.optType();">
			<label for="map_type_control">Map Type Control</label></td>
			<td>
				<label for="map_type" class="fl lbl_style">Type</label>
				<select title="select rows" name="map_type" id="map_type" disabled="" onchange="adminPageSettings.changeMapType();">
			...
			<td>
				...
				<select title="select rows" name="map_type_position" id="map_type_position" disabled="" onchange="adminPageSettings.changeMapTypePosition();">
					<option value="0" selected="">Top Left</option>
					<option value="1">Top Right</option>
					<option value="2">Top Center</option>
					<option value="3">Left Top</option>
		...
		<tr>
			<td>
			<input type="checkbox" name="scale_control" id="scale_control" onclick="adminPageSettings.optScale();">
			<label for="scale_control">Scale</label></td>
			<td colspan="2">
				<label for="scale_control_position" class="fl lbl_style">Position</label>
				<select title="select rows" class="rows" name="scale_control_position" id="scale_control_position" disabled="" onchange="adminPageSettings.changeScaleControlPosition();">
					<option value="0" selected="">Top Left</option>
					<option value="1">Top Right</option>
					<option value="2">Top Center</option>
					<option value="3">Left Top</option>
		...
		<tr>
			<td>
			<input type="checkbox" name="street_view_control" id="street_view_control" onclick="adminPageSettings.optStreet();">
			...
			<td colspan="2">
				...
				<select title="select rows" class="rows" name="street_view_position" id="street_view_position" disabled="" onchange="adminPageSettings.changeStreetViewPosition();">
					<option value="0" selected="">Top Left</option>
					<option value="1">Top Right</option>
					<option value="2">Top Center</option>
					<option value="3">Left Top</option>
...
<div id="google_map_marker_search" style="width: 650px; top: 409px; left: 627px; z-index: 10002;display:none;"><h3 id="pop_header">Insert Google Marker</h3><div class="admin_popup_contents">
    ...
    <tbody><tr>
        <th>
            <ul class="marker_type">
                <li>
                    <label for="marker_01"><img src="{$sPgDir}/images/icon_marker_01.png" alt="google marker 1"></label>
                    <input type="radio" name="marker_type" id="marker_01" class="input_rdo" checked="checked" value="1">
                </li>
                <li>
                    <label for="marker_02"><img src="{$sPgDir}/images/icon_marker_02.png" alt="google marker 2"></label>
                    <input type="radio" name="marker_type" id="marker_02" class="input_rdo" value="2">
                </li>
                <li>
                    <label for="marker_03"><img src="{$sPgDir}/images/icon_marker_03.png" alt="google marker 3"></label>
                    <input type="radio" name="marker_type" id="marker_03" class="input_rdo" value="3">
                </li>
                <li>
                    <label for="marker_04"><img src="{$sPgDir}/images/icon_marker_04.png" alt="google marker 4"></label>
                    <input type="radio" name="marker_type" id="marker_04" class="input_rdo" value="4">
                </li>
                <li>
                    <label for="marker_05"><img src="{$sPgDir}/images/icon_marker_05.png" alt="google marker 5"></label>
    ...
    <div class="ly_cnt_btn"><a href="javascript: adminPageSettings.openPopupMarkerSearch();" class="btn_ly" title="Add new marker">Add New Marker</a></div>
